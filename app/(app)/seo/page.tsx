      ...
      <div className="space-y-6">
        ...
        <section className="grid gap-6 xl:grid-cols-[320px_minmax(0,1fr)]">
          <div className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
            <div className="mb-4">
              <div className="text-sm font-semibold text-slate-900">網站清單</div>
              <div className="text-xs text-slate-500">選擇要分析的站點</div>
            </div>

            {loadingSites ? (
              <div className="text-sm text-slate-500">載入站點中...</div>
            ) : sites.length === 0 ? (
